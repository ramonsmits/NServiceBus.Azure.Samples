...
namespace VideoStore.CustomerRelations
{
    ...
    {
        static ILog Log = LogManager.GetLogger(typeof(SendWelcomePacket));
        ...
        public void Handle(ClientBecamePreferred message)
        {
            ...
            Log.DebugFormat("Handler WhenCustomerIsPreferredSendWelcomeEmail invoked for CustomerId: {0}", message.ClientId);
