...
namespace VideoStore.Operations
{
    ...
    {
        static ILog Log = LogManager.GetLogger(typeof(ProvisionDownloadHandler));
        ...
        public void Handle(ProvisionDownloadRequest message)
        {
            ...
            Log.DebugFormat("Provision the videos and make the Urls available to the Content management for download ...[{0}] video(s) to provision", String.Join(", ", message.VideoIds));
